...
export class Lighting {
	...
	public directionUniform!: UniformNode<THREE.Vector3>
	public colorUniform!: UniformNode<THREE.Color>
	...
	public shadowColor!: UniformNode<THREE.Color>
	public bounceColor!: UniformNode<THREE.Color>
	...
	// Helpers
	private directionHelper!: THREE.Mesh
	...
	public initialize() {
		...
		const config: LightingConfig = {
			...
			coreShadowEdgeLow: -0.2, // 명암 경계 부드러움 조절
			coreShadowEdgeHigh: 0.2,
			lightBounceEdgeLow: 0.33,
			lightBounceEdgeHigh: -0.22,
			lightBounceDistance: 30.0, // 반사광이 도달하는 높이
			lightBounceMultiplier: 0.67, // 반사광 강도
		}
		...
		this.colorUniform = uniform(color(this.debugOptions.lightColor))
		...
		this.shadowColor = uniform(color(this.debugOptions.shadowColor))
	...
	public update() {
		...
		// 5. [핵심] TSL Uniform 업데이트
		// 이 한 줄이 모든 Material의 빛 방향을 동기화합니다.
